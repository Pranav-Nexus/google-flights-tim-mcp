...
export type AircraftEmissionsProfile = {
  ...
  readonly fuelGramsPerPaxKm: number; // Baseline economy seating at 82% load factor
...
export const AIRCRAFT_PROFILES: readonly AircraftEmissionsProfile[] = [
