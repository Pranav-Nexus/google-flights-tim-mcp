...
export const handleFlightUrl = async (params) => {
    const url = buildGoogleFlightsUrl(params.origin, params.destination, params.departureDate, params.returnDate ?? null, params.cabinClass ?? "economy", params.currency ?? "USD");
    return ok(`Direct Google Flights Search Link:\n${url}\n\nThis shareable URL opens Google Flights directly with your selected route, dates, cabin class, and currency pre-loaded.`);
};
//# sourceMappingURL=flight-url.js.map