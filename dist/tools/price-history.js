...
export const handlePriceHistory = async (params) => {
    const historyRes = getRouteHistory(params.origin, params.destination, params.departureDate, params.returnDate ?? null);
    if (historyRes.tag === "err")
        return historyRes;
