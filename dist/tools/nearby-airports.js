...
export const handleNearbyAirports = async (params) => {
    ...
    return ok(`Airports within ${params.radiusKm ?? 200}km of ${airport.name} [${params.code.toUpperCase()}]:\n${lines.join("\n")}`);
};
//# sourceMappingURL=nearby-airports.js.map