...
export const handleTrackPrice = async (params) => {
    ...
    const recRes = recordPrice(params.origin, params.destination, params.departureDate, params.returnDate ?? null, flight.price, flight.currency ?? "USD");
    if (recRes.tag === "err")
        return recRes;
...
//# sourceMappingURL=track-price.js.map