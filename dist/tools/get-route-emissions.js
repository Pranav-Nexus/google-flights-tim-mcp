import { z } from "zod";
import { computeRouteDistanceKm, computeEffectiveDistanceKm, computeLegEmissions, } from "../tim/engine.js";
...
export const handleGetRouteEmissions = async (params) => {
    ...
    const ecoSavingsKg = Math.round((typicalEconomy.typicalRouteEmissionsGrams - nextGenEco.chosenCabinEmissionsGrams) / 1000);
    const ecoSavingsPct = Math.round(((typicalEconomy.typicalRouteEmissionsGrams - nextGenEco.chosenCabinEmissionsGrams) /
...
//# sourceMappingURL=get-route-emissions.js.map